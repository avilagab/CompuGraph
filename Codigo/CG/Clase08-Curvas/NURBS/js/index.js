      ...
      var clock = new THREE.Clock();
			...
			function init() {
				...
				var nurbsMaterial = new THREE.LineBasicMaterial( { color: 0xffffff, linewidth: 1, fog:true } );
				...
				var nurbsControlPointsMaterial = new THREE.LineBasicMaterial( { color: 0xcccccc, opacity: 0.25, transparent: true } );
				...
				var map = new THREE.TextureLoader().load( 'https://www.kingscourtgalleries.co.uk/backend/images/product/singleImage/mabi0419_l.jpg' );
        ...
        // loading manager
				...
				loader.load( 'https://trilo.design/chauffeur/wp-content/uploads/sites/5/2018/10/car-black.dae', function ( collada ) {
					elf = collada.scene;
          elf.scale.multiplyScalar( 50 );
				} );
